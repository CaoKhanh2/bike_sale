...
Route::middleware(['auth', 'role'])->group(function () {
     ...
     */
         ...
         */
            ...
            Route::get('/dashboard/category/vehicle/detail_automaker-info', function () {
                return view('dashboard.category.automaker.vehicle.detail_automaker-info');
            });

            // ---------- **** ----------

            // ---------- Dòng xe ----------
            Route::get('/dashboard/category/vehicle/vehicle-line_infor', function () {
                return view('dashboard.category.vehicle.vehicle-line.vehicle-line_infor');
            });

            Route::get('/dashboard/category/vehicle/vehicle-line_infor', [DongXeController::class, 'index']);
            Route::post('/dashboard/category/vehicle/vehicle-line_infor', [DongXeController::class, 'store'])->name('themdongxe');
            Route::get('/dashboard/category/vehicle/vehicle-line_infor/{id}', [DongXeController::class, 'destroy'])->name('xoadongxe');
         ...
         */
            ...
            Route::get('/dashboard/category/customer/detail_customer-info/{id}', [NguoiDungController::class, 'show'])->name('ctthongtinkhachhang');
            Route::patch('/dashboard/category/customer/detail_customer-info/{id}', [NguoiDungController::class, 'update'])->name('capnhatthongtinkhachhang');
    ...
    Route::get('/selling-item',[XeDangKyThuMuaController::class,'create'])->name('nhapxethumua');
