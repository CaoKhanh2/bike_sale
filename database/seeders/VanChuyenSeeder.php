...
class VanChuyenSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($i=0; $i < 25; $i++) { 
            VanChuyen::create([
                'mavanchuyen'=> $fake -> numerify('DVC-#####'),
                'khachhang_id' => $fake -> numerify('MKH-').$fake->randomElement(['0024', '0136', '0256', '0851', '1017', '1306', '2697', '3212', '3300', '3559', '3940', '4061', '4346', '4558', '4636', '4793', '7191', '8547', '9902', '9958']),
