<div class="card">
    <div class="card-header text-center" style="background-color:#4a90e2">
        <h3 class="text-white">Đăng ký bán xe</h3>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('thuchien-dangkythumua-Guest') }}" id="formthumua"
                ...
                <div class="col-md-5 mt-3">
                    ...
                    <div class="form-group">
                        <div class="dropzone mb-3 border border-3 border-primary"
                            action="{{ route('thuchien-dangkythumua-Guest') }}" id="mydropzone">
                            <div class="fallback">
                ...
                <div class="col-md-7 mt-3">
                    <div class="row">
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <select class="form-select form-select-lg border border-3 border-primary"
                                aria-label="Loại xe" id="loaixe" name="loaixe">
                        ...
                        <div class="mb-4 form-group">
                            <div class="row">
                                <div class="col-md-4 mb-3 mb-md-0">
                                    <select class="form-select form-select-lg border border-3 border-primary"
                                        aria-label="Loại xe" id="hangxe" name="hangxe">
