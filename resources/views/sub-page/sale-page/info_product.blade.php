        ...
        <div class="col-sm-6 col-md-8 ms-4">
            ...
            <div class="row">
                <div class="product-gap">
                    <h3>Bán xe Honda SH 125I sx 2010 Giá rẻ</h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-5">
                    <div class="time-area text-end">
                        <span>
                            <p class="fs-6 fst-italic">Tin đăng 4 ngày trước</p>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-5">
                    <div class="time-area text-end">
                        ...
                        <button type="button" class="btn btn-outline-primary">Lưu tin</button>
                    </div>
                </div>
            </div>
                                    ...
                                    <li class="list-group-item my-2 border-0 bg-light">
                                        <div class="hstack gap-3">
                                            <div class="p-2 d-flex align-items-center"><i
                                                    ...
                                                    <p class="d-inline px-2"> Năm đăng ký</p>
                                                </span></div>
                                            <div class="p-2 ms-auto">Second item</div>
                                        </div>
                                    </li>
                                    <li class="list-group-item my-2 border-0 bg-light">
                                        <div class="hstack gap-3">
                                            <div class="p-2 d-flex align-items-center"><img
                                                    ...
                                                    <p class="d-inline px-2">Dung tích xe</p>
                                                </span></div>
                                            <div class="p-2 ms-auto">Second item</div>
                                        </div>
                                    </li>
                                    <li class="list-group-item my-2 border-0 bg-light">
                                        <div class="hstack gap-3">
                                            <div class="p-2 d-flex align-items-center"><i
                                                    ...
                                                    <p class="d-inline px-2"> Số km đã đi</p>
                                                </span></div>
                                            <div class="p-2 ms-auto">Second item</div>
                                        </div>
                                    </li>
