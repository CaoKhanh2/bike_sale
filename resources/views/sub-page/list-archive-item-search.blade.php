                                ...
                                @foreach (explode(',', $i->hinhanh) as $path)
                                    @if ($loop->first)
                                        <img src="{{ asset('storage/' . $path) }}"
                                            class="object-fit-contain rounded img-fluid" alt="..."
                                            style="height: 180px; width: 100%;">
                                        @if ($i->giagoc != $i->giaban)
                                            <div class="overlay">{{ number_format($i->tilegiamgia, '0', ',') . '%' }}
                                            </div>
                                        @endif
                                    @endif
                                @endforeach
                                    ...
                                    <div class="row justify-content-center align-items-center g-2">
                                        ...
                                        <div class="col-6 col-md-6 mt-3 d-flex align-items-center">
                                            <img width="30" height="30"
                                                src="{{ asset('Image\Icon\icons8-moto-50.png') }}" alt="motorcycle" />
                                    ...
                                    <div class="row justify-content-center align-items-center g-2 mt-4">
                                        @if ($i->giagoc == $i->giaban)
                                            <div class="col-12 col-md-4 mt-3">
                                                <h4>
                                                    <span>
                                                        <strong class="d-inline text-danger fs-2">
