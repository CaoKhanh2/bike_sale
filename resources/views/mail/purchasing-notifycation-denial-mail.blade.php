    ...
    <div class="container">
        <div class="shadow p-3 mb-5 bg-body-tertiary rounded" style="width: 620px;">
            ...
            <div class="my-4 text-sm text-gray-600">
                ...
                <p>TP rất tiếc phải thông báo xe của bạn mã số {{' '. $dtm->madkthumua . ' '}} gửi ngày {{' '. $dtm->ngaydk .' ' }} đã không đăng ký bán thành công, bạn vui lòng hãy kiểm tra lại thông tin của xe đã gửi.</p>
            </div>
            <hr>
