...
<div class="left-side-bar">
    <div class="brand-logo">
        <a href="">
            <img src="{{ asset('dashboard_src/vendors/images/deskapp-logo.svg') }}" alt="" class="dark-logo" />
            <img src="{{ asset('dashboard_src/vendors/images/deskapp-logo-white.svg') }}" alt="" class="light-logo" />
        </a>
            ...
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon bi bi-textarea-resize"></span><span class="mtext">Danh mục</span>
                    </a>
                    <ul class="submenu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ url('/waiting_list') }}">Đăng ký bán</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="{{ url('custom-icon') }}">Custom Icons</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
