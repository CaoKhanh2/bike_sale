...
<body class="login-page">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7">
                    <img src="{{ asset('dashboard_src/vendors/images/register-page-img.png') }}" alt="" />
                </div>
    ...
    <script src="{{ asset('dashboard_src/src/plugins/jquery-steps/jquery.steps.js') }}"></script>
    <script src="{{ asset('dashboard_src/vendors/scripts/steps-setting.js') }}"></script>
