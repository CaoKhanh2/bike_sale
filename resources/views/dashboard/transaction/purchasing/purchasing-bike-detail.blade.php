                    ...
                    <div class="card-body">
                        <form action="" method="GET" id="ctformthumua">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control" name="bsx" value="{{number_format($dtm->giaban, 0, ',') . ' đ'}}" maxlength="12">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="submit" class="btn btn-primary me-md-0 mx-3 my-3" 
                                name="duyetdon" formaction="{{ route('duyetdonthumua', ['id' => $dtm->madkthumua]) }}">Duyệt đơn</button>
                                <button type="submit" class="btn btn-danger me-md-0 mx-3 my-3"
